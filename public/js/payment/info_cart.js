...
document.getElementById("checkout-btn").addEventListener("click", async function () {
    ...
    if(mercadopago){
        ...
        window.alert('Key não foi inserida no projeto, caminho do arquivo a ser modificado. public/js/payment/info_cart.js modifique a linha 105 insirindo sua key')
    }
